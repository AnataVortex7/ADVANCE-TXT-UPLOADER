...
async def help_command(client: Client, msg: Message):
    help_text = (
        "`/start` - Start the bot⚡\n\n"
        "`/akshay` - Download and upload files (sudo)🎬\n\n"
...
@bot.on_message(filters.command(["akshay"]))
async def upload(bot: Client, m: Message):
    ...
    credit = "️[𝗔𝗞𝗦𝗛𝗔𝗬](https://t.me/AnataVortex7)"
    if raw_text3 == '1':
        CR = '[𝗔𝗞𝗦𝗛𝗔𝗬](https://t.me/AnataVortex7)'
    elif raw_text3:
        try:
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            elif "https://appx-transcoded-videos.livelearn.in/videos/rojgar-data/" in url:
                url = url.replace("https://appx-transcoded-videos.livelearn.in/videos/rojgar-data/", "")
